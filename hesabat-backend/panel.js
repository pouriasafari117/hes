...
async function renderSrvDashboard(){
  ...
  main.innerHTML =
    ...
    '<div class="grid g-2" style="margin-top:14px"><div class="card tight"><div class="card-h"><h3>'+icon('swap',16)+'<span style="margin-inline-start:6px">آخرین تراکنش‌ها</span></h3><a class="btn btn-soft btn-sm" href="#/app/txns">همه '+icon('chevS',12)+'</a></div><div class="card-b" id="srvDashTxns"><p class="hint-t">در حال دریافت…</p></div></div>' +
